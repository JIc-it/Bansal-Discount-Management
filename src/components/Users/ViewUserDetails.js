        ...
        <div className="col-xl-12">
          ...
          <div className="card">
            <div className="card-body p-0">
              <div className="row">
                <div className="col-4 user-profile-image-container">
                ...
                <div className="col-8 p-4">
                  ...
                  <div className="active-user">
                    ...
                    <div className="button-user-section   my-2">
                      <div className="active-button">
                        <input type="radio" name="active-user" />
                    ...
                    <div className="edit-password-section">
                      ...
                      >
                        <img src={passwordIcon} alt="editIcon" />
